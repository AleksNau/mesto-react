...
export default function Card({
    ...
    return (
        <li className="elements__item">
            <img src={cardData.link} alt={cardData.name} className="elements__image" onClick={() => {
                getCard(cardData);
            }}/>
            <div className="elements__info">
                <p className="elements__text">{cardData.name}</p>
                <div className="elements__like-container">
                    <button type="button" className={cardLikeButtonClassName} onClick={() => onCardLike(cardData)}/>
